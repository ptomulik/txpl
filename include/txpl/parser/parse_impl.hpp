...
// txpl/parser/parse_impl.hpp

/** // doc: txpl/parser/parse_impl.hpp {{{
 * \file txpl/parser/parse_impl.hpp
 * \todo Write documentation
 */ // }}}
#ifndef TXPL_PARSER_PARSE_IMPL_HPP
#define TXPL_PARSER_PARSE_IMPL_HPP
