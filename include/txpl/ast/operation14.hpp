...
/** // doc: txpl/ast/operation14.hpp {{{
 * \file txpl/ast/operation14.hpp
 * \brief Defines \ref txpl::ast::operation "ast::operation<14>"
 */ // }}}
#ifndef TXPL_AST_OPERATION14_HPP_INCLUDED
#define TXPL_AST_OPERATION14_HPP_INCLUDED
...
struct operation<Iterator, Value, 14ul>
  : node<Iterator>
{
  /** // doc: base_type {{{
  ...
  /** // doc: expr_type {{{
   * \brief Type used to represent the AST nodes of the RHS subexpressions
   */ // }}}
  ...
  expr_type expr[2];
  /** // doc: level {{{
   * \brief Level number (precedence) of this operation, equals 14 for this
   *        specialization
   */ // }}}
...
#endif /* TXPL_AST_OPERATION14_HPP_INCLUDED */
