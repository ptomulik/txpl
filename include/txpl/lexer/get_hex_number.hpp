...
// txpl/lexer/get_hex_number.hpp

/** // doc: txpl/lexer/get_hex_number.hpp {{{
 * \file txpl/lexer/get_hex_number.hpp
 * \brief Implements \ref txpl::lexer::get_hex_number() "lexer::get_hex_number()"
 */ // }}}
...
namespace txpl { namespace lexer {
  /** // doc: get_hex_number() {{{
 * \ingroup LexerGroup
 * \brief Scan input for a hexadecimal number
 *
 ...
 * "hex-number" with semantic value retrieval.
 *
 * This function scans the content between iterators \e first and \e last
 * trying to decode a hexadecimal number. On success, the iterator \e first is
