...
#ifndef TXPL_TEST_SKIP_VM_EVAL_BINARY_GE
...
BOOST_AUTO_TEST_CASE(char__ge__char)
{
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
  {
...
BOOST_AUTO_TEST_CASE(char__ge__int)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(char__ge__bool)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(char__ge__real)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(char__ge__string)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(int__ge__char)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(int__ge__int)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(int__ge__bool)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(int__ge__real)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(int__ge__string)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(bool__ge__char)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(bool__ge__int)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(bool__ge__bool)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(bool__ge__real)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(bool__ge__string)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(real__ge__char)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(real__ge__int)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(real__ge__bool)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(real__ge__real)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(real__ge__string)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(string__ge__char)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(string__ge__regex)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(regex__ge__char)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(array__ge__char)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
...
BOOST_AUTO_TEST_CASE(object__ge__char)
{
  using namespace txpl::vm;
  value<> r;
  auto op = eval_binary_op<op_t::ge_, basic_types<> >(r);
