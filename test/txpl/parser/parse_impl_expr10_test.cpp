...
#define BOOST_TEST_MODULE test_txpl_parser_parse_impl_expr10

#include <txpl/test_config.hpp>
#include <boost/test/unit_test.hpp>

#ifndef TXPL_TEST_SKIP_PARSER_PARSE_IMPL_EXPR10
...
BOOST_AUTO_TEST_CASE(test__parse__expr_10__literal__op__literal)
{
  ...
  ast::expr<token_iterator, vm::basic_types<>, 10> e;
  ...
  ast::literal<token_iterator> l2;
  {
    ...
    lexer::token<> tok[] = {
      ...
      lexer::token<>(lexer::token_t::bitand_, beg[1], end[1]),
    ...
    BOOST_CHECK(e.tail.front().operator_ == vm::op_t::bitand_);
