...
#define BOOST_TEST_MODULE test_txpl_parser_parse_impl_expr14

#include <txpl/test_config.hpp>
#include <boost/test/unit_test.hpp>

#ifndef TXPL_TEST_SKIP_PARSER_PARSE_IMPL_EXPR14
...
BOOST_AUTO_TEST_CASE(test__parse__expr_14__literal__op__literal)
{
  ...
  ast::expr<token_iterator, vm::basic_types<>, 14> e;
  ...
  ast::literal<token_iterator> l2;
  {
    ...
    lexer::token<> tok[] = {
      ...
      lexer::token<>(lexer::token_t::or_, beg[1], end[1]),
    ...
    BOOST_CHECK(e.tail.front().operator_ == vm::op_t::or_);
